# coding: utf-8
"""
Django settings for econordeste project.
...
MIDDLEWARE_CLASSES = (
    ...
    'econordeste.current_user.CurrentUserMiddleware',
)

ROOT_URLCONF = 'econordeste.urls'

WSGI_APPLICATION = 'econordeste.wsgi.application'
...
DEFAULT_FROM_EMAIL = 'Eco Nordeste <no-reply@econordeste.gov.br>'
EMAIL_USE_TLS = True
EMAIL_HOST = 'smtpi.kinghost.net'
EMAIL_HOST_USER = 'no-reply@econordeste.gov.br'
EMAIL_HOST_PASSWORD = 'noRPLeco@9090'
EMAIL_PORT = 587
